 ...
 *          BookDao bookDao;
 *      }
 * 2)、Spring还支持使用@Resource(JSR250)和@Inject(JSR300)[java规范的注解]
 *       @Resource：
 ...
 */
@Configuration
@ComponentScan({"com.match.service","com.match.dao","com.match.controller","com.match.bean"})

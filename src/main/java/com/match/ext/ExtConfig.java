 ...
 *     在BeanFactory标注初始化之后调用，来定制和修改BeanFactory的内容；
 ...
 *                      并且加入容器中（beanFactory.registerSingleton("applicationEventMulticaster", this.applicationEventMulticaster);），
